<template>
  <div class="pay-main">
    <el-button type="primary" style="margin-left: 165px" icon="el-icon-delete">点我啊</el-button>
  ...
  export default {
    ...
    methods:{
      ...
      async open() {
        ...
        this.$alert(`<img src=${url} />`, '推荐使用微信支付', {
        ...
        //下面代码的作用：你需要知道支付成功|失败，需要一直发送请求，得知是否成功与失败的信息
